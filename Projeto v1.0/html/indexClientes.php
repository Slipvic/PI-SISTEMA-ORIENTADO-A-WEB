...
$sql = "SELECT p.id_produto, p.nome, p.avaliacao, p.preco, MAX(i.caminho) AS caminho FROM produto p LEFT JOIN imagem i ON p.id_produto = i.id_produto GROUP BY p.id_produto";
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Avaliação: <?php echo $produto['avaliacao'] ?></p>
