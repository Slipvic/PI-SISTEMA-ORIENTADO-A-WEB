...
<body>
    <div class="cadastro">
        ...
        <form id="formulario" action="" method="POST">
            ...
            <input type="text" name="CPF" id="CPF" placeholder="123.456.789-00" maxlength="14" required
                title="Digite um CPF válido no formato xxx.xxx.xxx-xx" oninput="validarCPF()" />
