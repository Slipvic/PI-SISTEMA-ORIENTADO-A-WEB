...
<head>
  ...
  <link rel="stylesheet" href="../styles/style-carrinho.css" />
  <style>
    .navbar {
...
<body>
  ...
  <body>
    ...
    <div class="container mt-5">
      ...
      ?>
      <button class="btn btn-primary mr-2" onclick="location.href='<?php echo isset($_SESSION['idusers']) ? 'formaPagamento.php' : 'login-client.php'; ?>'">
